...
pub(crate) mod felt {
    ...
    impl IntoFelt for starknet_in_rust::Felt252 {
        fn into_felt(self) -> stark_hash::Felt {
            stark_hash::Felt::from_be_slice(&self.to_bytes_be())
                .expect("Felt252 should fit into Felt")
        }
    }

    pub trait IntoFelt252 {
        fn into_felt252(self) -> starknet_in_rust::Felt252;
    }

    impl IntoFelt252 for stark_hash::Felt {
        fn into_felt252(self) -> starknet_in_rust::Felt252 {
            starknet_in_rust::Felt252::from_bytes_be(self.as_be_bytes())
        }
    }
}
